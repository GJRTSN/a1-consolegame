...
public class Wizard extends Hero {
    ...
    public Wizard(String name) {
        ...
        // Setting starting attributes for Wizard
        this.attributes = new HeroAttribute(1, 1, 8);

        // Setting valid weapons for Wizard
        this.validWeaponTypes = List.of(WeaponType.STAFF, WeaponType.WAND);

        // Setting valid armor types for Wizard
        this.validArmorTypes = List.of(ArmorType.CLOTH);
    }

    @Override
    public void levelUp() {
        // Setting the specified gain in attributes on level up for Wizard
        HeroAttribute levelUpAttributes = new HeroAttribute(1, 1, 5);

        // Increasing attributes according to Wizard level up logic
    ...
    @Override
    // GETTER for Wizard's attribute which contributes to total damage
